    ...
    fn test_complex_move_operations() {
        ...
        blocks.insert(
            ...
            BlockDoc {
                ...
                attributes: HashMap::from([
                    ...
                    (
                        "timestamp".to_string(),
                        "2025-03-25T20:18:15.200909".to_string(),
                    ),
                ]),
                delta: None,
                parent_id: None,
        ...
        let child_data = vec![
            ...
            (
                "1WVpT8",
                "7b2d08f0...",
                "2025-03-25T20:19:12.230850",
                Some("I4098s"),
            ),
            (
                "SXTmU4",
                "d5612d23...",
                "2025-03-25T20:22:48.866588",
                Some("UX_nxA"),
            ),
            (
                "jBMJf8",
                "7b2d08f0...",
                "2025-03-25T20:19:13.255235",
                Some("1WVpT8"),
            ),
            (
                "FcPUds",
                "d5612d23...",
                "2025-03-25T20:23:05.595778",
                Some("SXTmU4"),
            ),
            (
                "n9Bx2_",
                "7b2d08f0...",
                "2025-03-25T20:19:14.000000",
                Some("jBMJf8"),
            ),
            (
                "Zq4qVr",
                "d5612d23...",
                "2025-03-25T20:23:20.833103",
                Some("FcPUds"),
            ),
        ];
        ...
        assert_eq!(
            parent_children, &expected_order,
        ...
        let expected_after_move = vec![
            "I4098s", "1WVpT8", "jBMJf8", "n9Bx2_", "SXTmU4", "UX_nxA", "FcPUds", "Zq4qVr",
        ];

        assert_eq!(
            moved_children, &expected_after_move,
