...
use super::{document_types::{BlockActionDoc, DocumentState, ConcurrentAccessError}, utils::document_impl::{DocumentServiceImpl}};
...
impl DocumentService {
    ...
    #[inline(never)]
    #[frb]
    pub fn apply_action(&mut self, actions: Vec<BlockActionDoc>, diff_deltas: impl Fn(String, String) -> DartFnFuture<String>) -> Result<Vec<u8>, ConcurrentAccessError> {
    ...
    #[inline(never)]
    #[frb]
    pub fn get_document_json(&self) -> Result<DocumentState, ConcurrentAccessError> {
    ...
    #[inline(never)]
    #[frb]
    pub fn merge_updates(&self, updates: Vec<Vec<u8>>) -> Result<Vec<u8>, ConcurrentAccessError> {
    ...
    #[inline(never)]
    #[frb]
    pub fn apply_updates(&mut self, update: Vec<(String, Vec<u8>)>) -> FailedToDecodeUpdates {
    ...
    #[inline(never)]
    #[frb]
    pub fn init_empty_doc(&mut self) -> Result<Vec<u8>, ConcurrentAccessError> {
